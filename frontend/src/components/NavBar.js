...
const markNotificationsRead = async () => {
  ...
  return (
    <div className='logo-bar m-auto col-lg-10 col-sm-12 col-12 d-flex justify-content-between align-items-center'>
        ...
        '>
            <a className="mouse-pointer" href = "/"><img src = {logo} alt = 'Logo' className='logo' width = {162} height = {38}/></a>
        </div>
        ...
        <div className='d-flex align-items-center m-2'> 
          ...
          <div className='font-18 fw-bold'></div>
          <div className='currency p-0'><img src = {currency} className='currencyImg me-5' alt='coins' width = {20} height = {20}/></div>          
          </a>
          <div>
