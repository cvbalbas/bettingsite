...
export default function NavBar({ openLoginModal, openSignupModal, user, setUser, selectedOdds, setBetsOpen, betsOpen, handleClearAllBets, walletBalance, loading, setLoading}) {
  ...
  return (
    <div className='logo-bar m-auto col-lg-10 col-sm-12 col-12 d-flex justify-content-between align-items-center'>
        ...
        (<div className='d-flex align-items-center m-2'> 
          <div className='d-flex align-items-center pt-1 balance mouse-pointer'>
          ...
          <div className='mouse-pointer ps-4' onClick={() => setBetsOpen(!betsOpen)}>
