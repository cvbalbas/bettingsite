...
const LoginModal = ({ showModal, closeModal, user, setUser, setSignupModalOpen }) => {
  ...
  return (
    ...
    <Modal.Body className="bg-lightgreen text-lightgrey">
      ...
      <button className="mt-1 w-100 align-items-center d-flex justify-content-center btn border fw-bold text-white p-2" onClick={async () => {await handleGoogleLogin(); closeModal();}}>
    ...
    <Modal.Footer className="bg-lightgreen border-top-0 justify-content-center pt-0 pb-4">
