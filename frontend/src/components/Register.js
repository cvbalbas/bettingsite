...
const SignupModal = ({ showModal, closeModal, user, setUser, setLoginModalOpen, setDisclaimerOpen, setWalletBalance, phoneSetUp, setPhoneSetUp, registeredPhone, setRegisteredPhone, setLoading, setIsPremium, setRole, setUsernameInfo}) => {
  ...
  return (
    ...
    {step === "default" ? (
      ...
      <button className="mt-1 w-100 align-items-center d-flex justify-content-center btn border fw-bold text-white p-2" onClick={async () => {await handleGoogleSignup();  resetValues(); closeModal();}}>
    ...
    <Modal.Footer className="bg-lightgreen border-top-0 justify-content-center mt-0 pt-0 pb-4">
    {step === "default" ? (
